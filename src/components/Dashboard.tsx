    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((stat) => (
          <motion.div
            key={stat.id}
            className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 cursor-pointer hover:shadow-lg transition-all"
            variants={itemVariants}
          ...
          >
            ...
            <div className="mt-4 flex items-center">
              ...
              <span className="text-sm text-gray-500 ml-2">{t('thisMonth')}</span>
            </div>
          </motion.div>
        ))}
      </div>
        ...
        >
          ...
          <div className="space-y-4">
            {upcomingFestivals.map((festival, index) => (
              <div
                key={index}
                className="flex items-center space-x-4 p-3 bg-gradient-to-r from-orange-50 to-red-50 rounded-lg hover:from-orange-100 hover:to-red-100 transition-colors"
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-600 mt-1">{festival.relevance}</p>
                </div>
                <div className="text-right">
          ...
          <div className="mt-4 p-3 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <motion.button
            className="flex items-center space-x-3 p-4 bg-gradient-to-r from-primary to-blue-600 text-white rounded-lg hover:shadow-md transition-shadow"
          ...
          <motion.button
            className="flex items-center space-x-3 p-4 bg-gradient-to-r from-secondary to-green-600 text-white rounded-lg hover:shadow-md transition-shadow"
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
          ...
          <motion.button
            className="flex items-center space-x-3 p-4 bg-gradient-to-r from-orange-500 to-red-600 text-white rounded-lg hover:shadow-md transition-shadow"
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
